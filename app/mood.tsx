...
function Action({
  ...
  return (
    ...
    >
      <LinearGradient
        colors={[
          "rgba(239,255,249,0.34)",
          "rgba(172,224,208,0.09)",
        ]}
    ...
    <View style={styles.panel}>
      ...
      {panel === "quiz" && (
        <>
          {isQuizFinished ? (
            <>
              <Text style={styles.recommendKicker}>
                你的測驗報告
              </Text>
...
function handleSubmitRating(): void {
  // 這個函數由 PanelContent 內的按鈕使用。
  // 實際評分處理在 MoodScreen 中完成。
}

function handleReportReview(): void {
  // 實際檢舉處理由 PanelContent 中的 Alert 完成。
}
