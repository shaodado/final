...
export default function LoginScreen() {
  ...
  const login = () => {
    ...
    if (trimmedAccount === "adm" && password === "123") {
      signIn("admin");
      return;
    }

    if (trimmedAccount === "teach" && password === "321") {
      signIn("teacher");
      return;
    }
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          <View style={styles.hero}>
            ...
            <Text style={styles.kicker}>STUDENT SPACE</Text>
            <Text style={styles.title}>歡迎回來</Text>
            <Text style={styles.copy}>登入後，繼續安排你的學習生活。</Text>
          </View>
          <LinearGradient
          ...
          >
            ...
            >
              ...
              <Ionicons name="arrow-forward" size={19} color="#16445A" />
            </Pressable>
            <Text style={styles.hint}>
              預設帳號：adm / teach　密碼：123 / 321
            </Text>
          </LinearGradient>
        </KeyboardAvoidingView>
      </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  title: { color: "#F0FFF9", fontSize: 34, fontWeight: "800", marginTop: 9 },
  copy: { color: "#C3E0D8", fontSize: 14, marginTop: 9 },
  card: {
    borderRadius: 24,
    borderWidth: 1,
